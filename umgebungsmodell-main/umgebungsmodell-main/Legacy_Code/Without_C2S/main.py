...
class App:
    ...
    def __init__(self):
        ...
        self.selected_clamp_15 = 0
        self.selected_clamp_30 = 1
        self.drive_state = 0
        self.speed = 0
        self.rpm = 0
    ...
    def build_clamps_window(self):
        ...
        ControlGUI.create_clamps(self.clamps_window, self.selected_clamp_15, self.selected_clamp_30)
    ...
    def run_gui(self):
        ...
        while not self.program_terminated:
            try:
                ...
                self.edit_signal_list(2, "Steering angle", self.steering_angle(), "degrees")
    ...
    def update_throttle_window(self):
        ControlGUI.get_throttle_scale(self.throttle_window).set(self.throttle_value)
    ...
    def set_clamp_15_on(self):
        self.selected_clamp_15 = 1

    def set_clamp_15_off(self):
        self.selected_clamp_15 = 0

    def set_clamp_30_on(self):
        self.selected_clamp_30 = 1

    def set_clamp_30_off(self):
        self.selected_clamp_30 = 0
